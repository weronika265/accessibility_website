...
final class Version20220603083210 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE comments DROP location_id, CHANGE content_id content_id INT NOT NULL, CHANGE author_id author_id INT UNSIGNED NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE comments ADD location_id INT DEFAULT NULL, CHANGE content_id content_id INT DEFAULT NULL, CHANGE author_id author_id INT UNSIGNED DEFAULT NULL');
