...
final class Version20220603073800 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE comments CHANGE content_id content_id INT DEFAULT NULL, CHANGE location_id location_id INT DEFAULT NULL');
...
//        $this->addSql('ALTER TABLE opinions ADD CONSTRAINT FK_BEAF78D0F675F31B FOREIGN KEY (author_id) REFERENCES users (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE comments CHANGE content_id content_id INT NOT NULL, CHANGE location_id location_id INT NOT NULL');
